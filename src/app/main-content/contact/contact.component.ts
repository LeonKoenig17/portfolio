...
export class ContactComponent {
  ...
  togglePath() {
    ...
    this.currentPath = this.hasAgreed ? this.checkedPath : this.uncheckedPath;
  }
  onSubmit(ngForm: NgForm) {
    this.formSubmitted = true;
    if (ngForm.form.valid && this.hasAgreed && !this.mailTest) {
    ...
    } else if (ngForm.form.valid && this.hasAgreed && this.mailTest) {
      ngForm.resetForm();
      this.hasAgreed = false;
      this.currentPath = this.uncheckedPath;
      this.formSubmitted = false;
